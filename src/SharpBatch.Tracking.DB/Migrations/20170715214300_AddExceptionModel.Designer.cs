...
namespace SharpBatch.Tracking.DB.Migrations
{
    ...
    [Migration("20170715214300_AddExceptionModel")]
    partial class AddExceptionModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SharpBatch.Tracking.DB.data.ExceptionModel", b =>
                {
                    ...
                    b.Property<long?>("TrackingModelTrackingId");

                    b.HasKey("ExceptionId");

                    b.HasIndex("TrackingModelTrackingId");

                    b.ToTable("SB_Tracking_Exception");
                });
            ...
            modelBuilder.Entity("SharpBatch.Tracking.DB.data.ExceptionModel", b =>
                {
                    b.HasOne("SharpBatch.Tracking.DB.data.TrackingModel")
                        .WithMany("Ex")
                        .HasForeignKey("TrackingModelTrackingId");
                });
